 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jg=t=>{for(const e in t)if(e.startsWith("aria-")||e==="role"||e==="title")return!0;return!1};/**
 * @license lucide-react v0.575.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Lg=E.forwardRef(({color:t="currentColor",size:e=24,strokeWidth:n=2,absoluteStrokeWidth:r,className:i="",children:s,iconNode:o,...a},l)=>E.createElement("svg",{ref:l,...Og,width:e,height:e,stroke:t,strokeWidth:r?Number(n)*24/Number(e):n,className:Hh("lucide",i),...!s&&!jg(a)&&{"aria-hidden":"true"},...a},[...o.map(([u,m])=>E.createElement(u,m)),...Array.isArray(s)?s:[s]]));/**
 * @license lucide-react v0.575.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const W=(t,e)=>{const n=E.forwardRef(({className:r,...i},s)=>E.createElement(Lg,{ref:s,iconNode:e,className:Hh(`lucide-${Rg(Ku(t))}`,`lucide-${t}`,r),...i}));return n.displayName=Ku(t),n};/**
 * @license lucide-react v0.575.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zs=new np("@firebase/auth");function iv(t,...e){Zs.logLevel<=H.WARN&&Zs.warn(`Auth (${Li}): ${t}`,...e)}function ks(t,...e){Zs.logLevel<=H.ERROR&&Zs.error(`Auth (${Li}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fa=Np("rcb"),jw=new Di(3e4,6e4);class Lw{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!((e=le().grecaptcha)!=null&&e.render)}load(e,n=""){return I(Dw(n),e,"argument-error"),this.shouldResolveImmediately(n)&&ld(le().grecaptcha)?Promise.resolve(le().grecaptcha):new Promise((r,i)=>{const s=le().setTimeout(()=>{i(Ue(e,"network-request-failed"))},jw.get());le()[fa]=()=>{le().clearTimeout(s),delete le()[fa];const a=le().grecaptcha;if(!a||!ld(a)){i(Ue(e,"internal-error"));return}const l=a.render;a.render=(u,m)=>{const p=l(u,m);return this.counter++,p},this.hostLanguage=n,r(a)};const o=`${Pv()}?${Tr({onload:fa,render:"explicit",hl:n})}`;Ic(o).catch(()=>{clearTimeout(s),i(Ue(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var n;return!!((n=le().grecaptcha)!=null&&n.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function Dw(t){return t.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(t)}class Mw{async load(e){return new Lv(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
